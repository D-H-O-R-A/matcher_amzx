...
class SwaggerDocService(val apiClasses: Set[Class[_]], override val host: String) extends SwaggerHttpService {
  ...
  override val info: Info = Info(
    description = "The Web Interface to the Amzx Matcher Server API",
    version = Version.VersionString,
    title = "Amzx Matcher Server",
    license = Some(License("MIT License", "https://better2better.com.br/matcher/blob/master/LICENSE"))
  )
